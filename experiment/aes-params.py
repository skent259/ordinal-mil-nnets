...
experiment_201 = expand_grid(
    {
        ...
        "data_set_name": [
            "aes_bag_wr=0.5_size=4_i=0_j=0_train.csv",
            "aes_bag_wr=0.5_size=4_i=0_j=1_train.csv",
            "aes_bag_wr=0.5_size=4_i=0_j=2_train.csv",
            "aes_bag_wr=0.5_size=4_i=0_j=3_train.csv",
            "aes_bag_wr=0.5_size=4_i=0_j=4_train.csv",
        ],
        "batch_size": [1],
