...
experiment_101 = expand_grid(
    {
        ...
        "data_set_type": [DataSetType.FGNET],
        "data_set_name": [
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=0_j=0",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=0_j=1",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=0_j=2",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=0_j=3",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=0_j=4",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=1_j=0",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=1_j=1",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=1_j=2",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=1_j=3",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=1_j=4",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=2_j=0",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=2_j=1",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=2_j=2",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=2_j=3",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=2_j=4",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=3_j=0",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=3_j=1",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=3_j=2",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=3_j=3",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=3_j=4",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=4_j=0",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=4_j=1",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=4_j=2",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=4_j=3",
            "splits_bag/fgnet_bag_wr=0.5_size=4_i=4_j=4",
        ],
        "batch_size": [1],
        "learning_rate": [0.01, 0.001, 0.0001],
        "epochs": [150],
