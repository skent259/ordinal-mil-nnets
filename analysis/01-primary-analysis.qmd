...
exp_list <- c("fgnet-1.0.1", "fgnet-1.0.2", "fgnet-1.0.3")
...
```{r}
plot_training_progression(df_train_prog, c("fgnet-1.0.1", "fgnet-1.0.2", "fgnet-1.0.3"), 
...
```{r}
exp_list <- c("fgnet-1.0.1", "fgnet-1.0.2", "fgnet-1.0.3", "aes-2.0.1", "aes-2.0.2")
df_metrics %>% 
  filter(experiment %in% exp_list) %>% 
