...
# exp_list <- c("fgnet-1.0.1", "fgnet-1.0.2", "aes-2.0.1")
...
#| fig-cap: Single factor effects of Ordinal method with MAE outcome
plot_one_factor(df_metrics, exp_list, "ordinal_method", "mae", facets = "data_set_type")
```

```{r}
#| label: fig-1f-boxplot-acc-ordinal
#| fig-cap: Single factor effects of Ordinal method with accuracy outcome
plot_one_factor(df_metrics, exp_list, "ordinal_method", "acc", facets = "data_set_type")
```

```{r}
#| label: fig-1f-boxplot-mae-mil
#| fig-cap: Single factor effects of MIL method with MAE outcome
plot_one_factor(df_metrics, exp_list, "mil_method", "mae", facets = "data_set_type")
```

```{r}
#| label: fig-1f-boxplot-acc-mil
#| fig-cap: Single factor effects of MIL method with accuracy outcome
plot_one_factor(df_metrics, exp_list, "mil_method", "mae", facets = "data_set_type")
```
...
files_of_interest <- 
  df_metrics %>% 
  filter(experiment %in% c("aes-2.0.1")) %>% 
  filter(n_pred > 1) %>% 
  pull(file)
