"""
File copied from https://github.com/yanyongluan/MINNs/blob/master/MI_Net.py
2022-09-15
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--lr", dest="init_lr", help="initial learning rate", default=5e-4, type=float
    )
    parser.add_argument(
        "--decay", dest="weight_decay", help="weight decay", default=0.005, type=float
    )
    parser.add_argument(
